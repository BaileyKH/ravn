    ...
    const fetchFoodSpotsAlongRoute = async (path) => {
        ...
        for (const point of sampled) {
            const url = `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${
                ...
                filters.maxDistanceFromRoute * 1609
            }&type=restaurant&key=${GOOGLE_API_KEY}${
                filters.foodType ? `&keyword=${filters.foodType}` : ""
            ...
            >
                ...
                <View>
                    ...
                    {foodDropdownVisible && (
                        <View style={styles.dropdownList}>
                            <TextInput
                                ...
                                onChangeText={(text) =>
                                    setFoodSearch(text.toLowerCase())
                                }
                            />
                    ...
                    <Text style={[styles.filterLabel, { marginTop: 12 }]}>
                        Max Distance Off Route: {filters.maxDistanceFromRoute}{" "}
                        mi
                    </Text>
                        ...
                        {[0.5, 1, 2, 5].map((distance) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    ...
                                    filters.maxDistanceFromRoute === distance &&
                                        styles.activeFoodType,
                                ]}
                                onPress={() =>
                                    setFilters((prev) => ({
                                        ...prev,
                ...
                <View style={styles.infoCard}>
                    ...
                    <View style={styles.infoRow}>
                        <View style={styles.ratingStars}>
                            ...
                            {selectedSpot.rating && (
                                <Text style={styles.infoRatingText}>
                                    ({selectedSpot.rating})
                                </Text>
                            )}
                        </View>
                    ...
                    {selectedSpot.opening_hours && (
                        <Text
                            style={[
                                styles.infoStatus,
                                {
                                    color: selectedSpot.opening_hours.open_now
                                        ? "#00FF7F"
                                        : "#FF3B3F",
                                },
                            ]}
